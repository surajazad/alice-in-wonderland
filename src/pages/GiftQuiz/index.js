  ...
  const handleClick = (question, answer) => {
    ...
    return (
        <div className="gift-quiz" style={{
            background: `url('${process.env.PUBLIC_URL}/images/utility/heart3.jpg')`
          }}>
            <div className="title">
                <h1>Gift Quiz</h1>
                <p></p>
            ...
            <div className="gift_questions sub-margin">
                ...
                <div className="gift-is-for" id="gift-is-for">
                    <button className="question_width fab-content" id="me" onClick={()=>{handleClick("gift-is-for", "me")}}>ME</button>
                    <button className="question_width fab-content" id="amazing-other-half" onClick={()=>{handleClick("gift-is-for", "amazing-other-half")}}>AMAZING OTHER HALF</button>
                    <button className="question_width fab-content" id="beautiful-friend" onClick={()=>{handleClick("gift-is-for", "beautiful-friend")}}> BEAUTIFUL FRIEND</button>
                    <button className="question_width fab-content" id="awesome-sibling" onClick={()=>{handleClick("gift-is-for", "awesome-sibling")}}>AWESOME SIBLING</button>
                    <button className="question_width fab-content" id="lovely-partner" onClick={()=>{handleClick("gift-is-for", "lovely-partner")}}>LOVELY PARTNER</button>
                </div>
                <hr/>
                ...
                <div className="occasion gift-is-for" id="occasion">
                    <div className="" id="anniversary" onClick={()=>{handleClick("occasion", "anniversary")}}>
                        ...
                        <div className="fab-label">Anniversary</div>
                    </div>
                    <div className="" id="birthday" onClick={()=>{handleClick("occasion", "birthday")}}>
                        ...
                        <div className="fab-label">Birthday</div>
                    </div>
                    <div className="" id="bachelorette"  onClick={()=>{handleClick("occasion", "bachelorette")}}>
                        ...
                        <div className="fab-label">Bachelorette</div>
                    </div>
                    <div className="" id="valentines" onClick={()=>{handleClick("occasion", "valentines")}}>
                        ...
                        <div className="fab-label">Valentines</div>
                    </div>
                </div>
                <hr/>
                ...
                <div className="category-lover" id="category-lover">
                    <div className="" id="body-care-lover" onClick={()=>{handleClick("category-lover", "body-care-lover")}}>
                        ...
                        <div className="fab-label">BODY CARE LOVER</div>
                    </div>
                    <div className="" id="fragrance-lover" onClick={()=>{handleClick("category-lover", "fragrance-lover")}}>
                        ...
                        <div className="fab-label">FRAGRANCE LOVER</div>
                    </div>
                    <div className="" id="lingerie-lover" onClick={()=>{handleClick("category-lover", "lingerie-lover")}}>
                        ...
                        <div className="fab-label">LINGERIE LOVER</div>
                    </div>
                    <div className="" id="accessory-lover" onClick={()=>{handleClick("category-lover", "accessory-lover")}}>
                        ...
                        <div className="fab-label">ACCESSORY LOVER</div>
                    </div>
                </div>
                <hr/>
                <div className="text-align">I WANT TO SPEND...</div>
                <div className="i-want-to-spend" id="i-want-to-spend">
                    <button className="question_width fab-content" id="$10-$50" onClick={()=>{handleClick("i-want-to-spend", "$10-$50")}}>$10-$50</button>
                    <button className="question_width fab-content" id="$50-$100" onClick={()=>{handleClick("i-want-to-spend", "$50-$100")}}>$50-$100</button>
                    <button className="question_width fab-content" id="$100&Above" onClick={()=>{handleClick("i-want-to-spend", "$100&Above")}}>$100 & Above</button>
                </div>
            </div>
            <hr/>
            <Link to={`/gift`}>
                <div className="find-your-gift">
                    <button className="gift_quiz_btn fab-content">FIND YOUR GIFT <i class="fa-solid fa-gift"></i></button>
                </div>
            </Link>
        </div>
    )
